...
3. Build images:
```
docker buildx build --no-cache --platform=linux/arm64 --tag=ghcr.io/gjpin/demo-apps-load-app:55.0 ./load-app
docker buildx build --no-cache --platform=linux/arm64 --tag=ghcr.io/gjpin/demo-apps-bff1:55.0 ./bff1
docker buildx build --no-cache --platform=linux/arm64 --tag=ghcr.io/gjpin/demo-apps-bff2:55.0 ./bff2
docker buildx build --no-cache --platform=linux/arm64 --tag=ghcr.io/gjpin/demo-apps-backend1:55.0 ./backend1
docker buildx build --no-cache --platform=linux/arm64 --tag=ghcr.io/gjpin/demo-apps-backend2:55.0 ./backend2
```
...
4. Push images:
```
docker push ghcr.io/gjpin/demo-apps-load-app:55.0
docker push ghcr.io/gjpin/demo-apps-bff1:55.0
docker push ghcr.io/gjpin/demo-apps-bff2:55.0
docker push ghcr.io/gjpin/demo-apps-backend1:55.0
docker push ghcr.io/gjpin/demo-apps-backend2:55.0
```
...
3. Build images:
```
podman build --no-cache --tag=ghcr.io/gjpin/demo-apps-load-app:55.0 ./load-app
podman build --no-cache --tag=ghcr.io/gjpin/demo-apps-bff1:55.0 ./bff1
podman build --no-cache --tag=ghcr.io/gjpin/demo-apps-bff2:55.0 ./bff2
podman build --no-cache --tag=ghcr.io/gjpin/demo-apps-backend1:55.0 ./backend1
podman build --no-cache --tag=ghcr.io/gjpin/demo-apps-backend2:55.0 ./backend2
```
4. Push images:
```
podman push ghcr.io/gjpin/demo-apps-load-app:55.0
podman push ghcr.io/gjpin/demo-apps-bff1:55.0
podman push ghcr.io/gjpin/demo-apps-bff2:55.0
podman push ghcr.io/gjpin/demo-apps-backend1:55.0
podman push ghcr.io/gjpin/demo-apps-backend2:55.0
```
